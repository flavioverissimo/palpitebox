        ...
        <div className="lg:flex lg:items-center lg:-mx-6">
          <div className="lg:w-1/2 lg:mx-6">
            ...
            <div className="mt-6 space-y-8 md:mt-8">
              <p className="flex items-start -mx-2">
                ...
                <span className="mx-2 text-gray-700 truncate w-72">
                  Rua nome da rua, nº - Bairro / Estado
                </span>
              </p>
            ...
            <div className="mt-6 w-80 md:mt-8">
              <h3 className="text-gray-600">Siga nos</h3>

              <div className="flex mt-4 -mx-1.5 ">
                <Link href="">
                  <a className="mx-1.5 text-gray-400 transition-colors duration-300 transform hover:text-blue-500">
                    <svg
            ...
            <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white rounded-lg shadow-2xl lg:max-w-xl shadow-gray-300/50">
                ...
                <div>
                  ...
                  <div className="mt-6">
                    ...
                    <div className="flex-1 mt-6">
                      ...
                      <input
                        type="email"
                        placeholder="joaocarlos@example.com"
                        className="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"
                        name="Email"
                        onChange={onChange}
              ...
              {responseState.status && (
                <div className="text-center">
                  <img src="correct.png" className="w-1/6 mx-auto mb-4" />
                  <h3 class="font-medium text-3xl leading-6 text-gray-800 capitalize mb-10">
                    Obrigado!
                  </h3>
                  <p class="mt-2 text-sm text-gray-500 mb-10">
                    O seu contato foi enviado com sucesso. Assim que
                    verificarmos sua mensagem, retornaremos o mais breve
                    possível!
                  </p>
                  <button onClick={returnForm} className="">
                    Voltar
                  </button>
                </div>
              )}
